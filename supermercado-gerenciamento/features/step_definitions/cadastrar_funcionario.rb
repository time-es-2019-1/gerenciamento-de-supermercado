...
When("Preencho os campos de CPF com {string}, nome com {string}, Ano nascimento {string}, Mes nascimento {string}, Dia nascimento {string}, Telefone {string}, Salario {string}, Cargo {string}, Ano admissao {string}, Mes Admissao {string}, Dia admissao {string}, Ano pagamento {string}, Mes pagamento {string}, Dia pagamento {string}, Bairro {string}, Rua {string}, Cidade {string}, CEP {string}, Numero {string}") do |cpf, nome, anoNascimento, mesNascimento, diaNascimento, telefone, salario, cargo, anoAdmissao, mesAdmissao, diaAdmissao, anoPagamento, mesPagamento, diaPagamento, bairro, rua, cidade, cep, numero|
