...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { cliente_id: @venda.cliente_id, codigo: @venda.codigo, data: @venda.data, funcionario_id: @venda.funcionario_id, valor_pago: @venda.valor_pago, valor_total: @venda.valor_total } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente_id: @venda.cliente_id, codigo: @venda.codigo, data: @venda.data, funcionario_id: @venda.funcionario_id, valor_pago: @venda.valor_pago, valor_total: @venda.valor_total } }
